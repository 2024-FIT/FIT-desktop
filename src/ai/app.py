...
def recommend_diet_api():
    ...
    daily_caloric_needs = calculate_caloric_needs(bmi)
    recommended_diet = recommend_diet(knn, daily_caloric_needs, scaler, data)

    return jsonify(recommended_diet)
